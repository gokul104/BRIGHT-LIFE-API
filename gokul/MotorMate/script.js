...
// Remove loading indicator function with slight delay for smooth UX
...
async function sendResponse() {
    ...
    if (userMessage) {
        try {
            ...
            simulateTypingEffect(`Bot: ${data.response}`, botMessage);
...
window.addEventListener('load', () => {
    ...
    welcomeMessage.textContent = 'Bot: "Welcome to Bright Lift, where every chat is a step toward a brighter tomorrow. How can I help?"';
